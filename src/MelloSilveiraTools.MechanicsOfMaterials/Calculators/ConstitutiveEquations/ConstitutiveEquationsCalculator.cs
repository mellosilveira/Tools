...
namespace MelloSilveiraTools.MechanicsOfMaterials.Calculators.ConstitutiveEquations;

/// <summary>
/// It contains the Mechanics of Materials constitutive equations.
/// </summary>
public class ConstitutiveEquationsCalculator : IConstitutiveEquationsCalculator
{
    /// <inheritdoc/>
    ...
    /// <inheritdoc/>
    public double CalculateColumnEffectiveLengthFactor(FasteningType fasteningType) => fasteningType switch
    {

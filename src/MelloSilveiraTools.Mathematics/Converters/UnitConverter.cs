...
public static class UnitConverter
{
    ...
    /// <summary>
    /// Converts each component of a <see cref="Vector3D"/> from radians to degrees.
    /// </summary>
    /// <param name="value">The vector whose components are in radians.</param>
    /// <returns>A new <see cref="Vector3D"/> with each component expressed in degrees.</returns>

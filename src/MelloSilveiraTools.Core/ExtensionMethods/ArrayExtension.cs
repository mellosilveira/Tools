...
public static class ArrayExtension
{
    ...
    public static double[] NormalizeVector(this double[] vector)
    {
        ...
        return [.. vector.Select(item => item / vectorNorm)];
    }
    ...
    {
        double value = vector.Sum(v => Math.Pow(v, 2));
    ...
    /// <param name="matrix"></param>
    /// <param name="vector"></param>
    /// <returns>A new vector with the value of multiplication between a matrix and a vector.</returns>
    ...
    /// <returns></returns>
    public static double[] Multiply(this double[] vector, double number) => [.. vector.Select(item => item * number)];
    ...
    /// <returns></returns>
    public static double[] Sum(this double[] vector1, double[] vector2) => vector1.MathOperation((v1, v2) => v1 + v2, vector2);
    ...
    /// <param name="vector2"></param>
    /// <returns></returns>
    public static double[] Subtract(this double[] vector1, double[] vector2) => vector1.MathOperation((v1, v2) => v1 - v2, vector2);
    ...
    public static double[] MathOperation(this double[] vector1, Func<double, double, double> func, double[] vector2)
    {
        ...
        return [.. vector1.Zip(vector2, func)];
    }
    ...
    {
        double[] value = new double[baseVector.Length];
        for (int i = 0; i < baseVector.Length; i++)
        {
            value[i] = baseVector[i];
    ...
    public static double[] Subtract(this double[] vector1, double[] vector2, double[] vector3)
    {
        ...
        double[] value = new double[vector1.Length];
        for (int i = 0; i < vector1.Length; i++)
        {
            value[i] = vector1[i] - vector2[i] - vector3[i];
        }
